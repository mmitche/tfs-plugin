...
public class CheckoutActionTest {
    ...
    public void assertFirstCheckoutBySingleVersionSpecNotUsingUpdate() throws Exception {
    	...
    	new CheckoutAction("workspace", "project", new ArrayList<String>(), ".", false).checkoutBySingleVersionSpec(server, hudsonWs, MY_LABEL);
    ...
    public void assertFirstCheckoutBySingleVersionSpecUsingUpdate() throws Exception {
        ...
        new CheckoutAction("workspace", "project", new ArrayList<String>(), ".", true).checkoutBySingleVersionSpec(server, hudsonWs, MY_LABEL);
    ...
    public void assertWorkFolderIsCleanedIfNotUsingUpdateCheckingOutByLabel() throws Exception {
        ...
        new CheckoutAction("workspace", "project", new ArrayList<String>(), "tfs-ws", false).checkoutBySingleVersionSpec(server, hudsonWs, MY_LABEL);
